...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener, SeekBar.OnSeekBarChangeListener {
    ...
    public void updateTotal(){
        List<String> a = new ArrayList<String>( ); // create an array
        for (int i = 0; i < dinerList.size(); i++){
            ...
            a.add(dinerList.get(i).etName.getText().toString()); // add the diner's names into the array

        }
        Collections.sort(a); // sort the names alphabetically
